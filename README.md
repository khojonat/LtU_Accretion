# LtU_Accretion
Repo for code related to my LtU accretion project testing Bondi, ff, and modff accretion models in different environments and with different AGN and stellar feedback strengths.
